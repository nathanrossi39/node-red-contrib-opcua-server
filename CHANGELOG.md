...
* feat!: rename server node type to opcua-compact-server-v2 ([5a8cf5a](https://github.com/nathanrossi39/node-red-contrib-opcua-server/commit/5a8cf5a36a88ffabc00785b366573e12a9eb7d6b))
